...
if(millis()-tiempo>6000 && pantalla>0 && pantalla<7){
pantalla++;
tiempo = millis();
...
fill(255);
fill(255,0,0);
text("1 asterion en el laberinto",xTitulo,60);

fill(255);
textSize(18);
text("asterion vive solo dentro de un laberinto",xTexto,80);

text("inmenso del cual no puede escapar, se lo acusa de soberbia",xTexto, 105);
...
fill(255,0,0);
text("postrado entre columnas",xTitulo,60);

fill(255);
textSize(18);
text("el minotauro recorre eternamente", xTexto, 80);

text("su prision entre patios y columnas", xTexto, 105);
}
...
fill(255,0,0);
text("la ofrenda esperada",xTitulo,60);

fill(255);
textSize(18);
text("cada 9 años llegan 9 hombres ", xTexto, 80);

text("adestinados al sacrificio.", xTexto, 105);
...
fill(255,0,0);
text("su eterna prision",xTitulo,60);
 
 fill(255);
 textSize(18);
 text(" juega y juega en su eterna prision", xTexto, 80);
 
 text("asterion está atrapado para siempre.", xTexto, 105);
...
text("el minotauro",xTitulo,60);

fill(255);
textSize(18);
text("finalmente comprendemos que...", xTexto, 80);

text("Asterion era el minotauro", xTexto, 105);
